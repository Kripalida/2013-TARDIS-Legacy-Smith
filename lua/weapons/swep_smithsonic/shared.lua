...
SWEP.UseHands = true
// First person Model
SWEP.ViewModel = "models/weapons/doctorwho1200/c_smithsonic.mdl"
// Third Person Model
SWEP.WorldModel = "models/weapons/doctorwho1200/w_smithsonic.mdl"
...
function SWEP:LoadFolder(folder,addonly,noprefix)
	folder="weapons/swep_smithsonic/"..folder.."/"
